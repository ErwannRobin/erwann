...
export const Hero = () => {
  return <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-20 text-center animate-fade-in">
        <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent leading-tight">Lovable Tools
      </h1>
        <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto font-light">Crafting delightful experiences with Lovable</p>
      </div>
